...
Le prototype est deployee dans un environnement de laboratoire conteneurise, compose d'une VM Linux, de services Docker pour Authentik, Flask, Tailscale, SSH cible et Wazuh. Les versions exactes doivent etre consignees dans le tableau de configuration final.

\section{Deployement d'Authentik (IAM)}
