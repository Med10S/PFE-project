...
In addition, the report presents an anomaly-detection solution focused on privileged administrators. It uses an unsupervised \textit{Isolation Forest} pipeline to analyze temporal and behavioral indicators such as login hour, day of week, weekend/night flags, new subnet usage, recent approval volume, action type, and status. A separate model is trained for each administrator, and high anomaly scores trigger enriched alerts sent to the SIEM for investigation and traceability.
